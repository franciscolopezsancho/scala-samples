package com.lightbend.types.selftypes.composition

import akka.actor.{Actor, ActorContext, ActorLogging, ActorSystem, Props}
import com.lightbend.types.selftypes.composition.CabinActor.Greeting
...
// This will not wokrk with ActorRef.
